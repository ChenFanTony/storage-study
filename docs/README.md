...
| Directory | Content |
|-----------|---------|
| [L2-distributed/consensus/](L2-distributed/consensus/m2-day01-distributed-concepts.md) | Consensus map (single decision vs replicated log), Raft, Paxos/Multi-Paxos, Viewstamped Replication, ZAB, Byzantine-fault boundary |
